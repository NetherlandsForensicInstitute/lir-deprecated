...
class TestTwoLevelModel(unittest.TestCase):
    ...
    data_train = np.loadtxt(os.path.join(dirname, 'resources/TLM/input/train_data.csv'), delimiter=",", dtype="float", skiprows=1,
                       usecols=range(1, 12))

    def test_mean_covariance_within(self):
        mean_cov_within_R = np.loadtxt(os.path.join(self.dirname, 'resources/TLM/R_output/MSwithin.csv'), delimiter=","
    ...
    def test_means_train(self):
        means_train_R = np.loadtxt(os.path.join(self.dirname, 'resources/TLM/R_output/means_z.csv'), delimiter=","
                               , dtype="float", skiprows=1)
    ...
    def test_kernel_bandwidth_sq(self):
        kernel_bandwidth_sq_R = np.loadtxt(os.path.join(self.dirname, 'resources/TLM/R_output/h2.csv'), delimiter=","
                               , dtype="float", skiprows=1)
    ...
    def test_between_covars(self):
        between_covars_R = np.loadtxt(os.path.join(self.dirname, 'resources/TLM/R_output/T0.csv'), delimiter=","
                               , dtype="float", skiprows=1)
        mean_cov_within_R = np.loadtxt(os.path.join(self.dirname, 'resources/TLM/R_output/MSwithin.csv'), delimiter=","
                                , dtype="float", skiprows=1)
