...
import os
import numpy as np
from lir.classifiers import TLM_calc_MSwithin, TLM_calc_means, TLM_calc_h_sq, TLM_calc_T0, TLM_calc_U, TLM_calc_mu
...
U_h0, U_hx, U_hn = TLM_calc_U(dataY[[0, 1, 2], 1:], dataX, MSwithin, h_sq, T0)
mu_hi = TLM_calc_mu(dataY[[0,1,2], 1:], dataX, MSwithin, means_z, h_sq, T0)
print("t")